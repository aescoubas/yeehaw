...
def _build_generation_prompt(project_name: str, user_text: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Use preview_roadmap(markdown=<draft>, color=True) to validate and refine drafts first.",
            f"- Call create_roadmap(project_name='{project_name}', markdown=<roadmap markdown>).",
            "- The markdown should use this verbose structure:",
            ...
            "- Number phases sequentially (phase 0 or phase 1 start both accepted).",
